...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Cursor_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_visible_0);
            args = new Type[]{typeof(UnityEngine.CursorLockMode)};
            method = type.GetMethod("set_lockState", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_lockState_1);


        }


        static StackObject* set_visible_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* set_lockState_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
