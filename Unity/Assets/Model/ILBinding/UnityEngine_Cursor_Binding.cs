...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Cursor_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_lockState_0);


        }


        static StackObject* set_lockState_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
